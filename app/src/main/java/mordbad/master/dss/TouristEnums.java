...
//    {"Besøke venner", "annen ferie", "forretningsreise","på vei til annet land","skiferie"}
    ...
    public static int[] historiske = {4, 22, 23, 26, 32, 41, 48, 55, 59};
    ...
    public static int[] lokal_historie = {22, 23, 26, 32, 41, 48, 50, 55, 59, 74, 78, 82, 87};
    public static int[] sightseeing = {2, 3, 4, 6, 8, 9, 11, 15, 20, 22, 23, 26, 32, 41, 43, 48, 50, 55, 59, 60, 62, 64, 68, 71, 73, 74, 76, 78, 82, 87, 89};
    public static int[] lokal_kultur = {3, 4, 22, 23, 26, 32, 33, 48, 55, 59, 60, 62, 71, 74, 78, 82, 86, 87, 89};
